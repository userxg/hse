1. Понятия алгоритма и программы. Языки программирования и машинный код. Переменные, типы данных, структуры данных. ~
**2. Понятия алгоритма и программы. Оценка трудоемкости (сложности) алгоритма. -**
3. Структура данных: массив. Алгоритмы вставки, удаления, замены и поиска элементов. +
4. Задача сортировки. Алгоритм сортировки выбором (selection sort). Алгоритм сортировки пузырьком (bubble sort). Алгоритм сортировки вставками (insertion sort). ~
